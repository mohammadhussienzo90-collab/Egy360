...
<div style="background: linear-gradient(135deg, #2e7d32 0%, #66bb6a 100%); border-radius: 15px; padding: 25px; margin: 30px 0; color: white; text-align: center;">
    ...
    <a href="https://tp.media/click?shmarker=688198&amp;promo_id=4504&amp;source_type=deeplink&amp;type=click&amp;campaign_id=100&amp;trs=477897&amp;url=https%3A%2F%2Fwww.aviasales.com%2Fsearch%2FCAI1" rel="noopener sponsored" target="_blank" style="display: inline-block; background: white; color: #2e7d32; padding: 12px 30px; border-radius: 25px; text-decoration: none; font-weight: bold;">Search Flights &rarr;</a>
...
<div style="background: linear-gradient(135deg, #ff6f00 0%, #ff8f00 100%); border-radius: 15px; padding: 25px; margin: 30px 0; color: white; text-align: center;">
    ...
    <a href="https://tp.media/click?shmarker=688198&amp;promo_id=4497&amp;source_type=deeplink&amp;type=click&amp;campaign_id=137&amp;trs=477897&amp;url=https%3A%2F%2Fwww.getyourguide.com%2Fs%2F%3Fq%3DGrand%2520Egyptian%2520Museum%2520tour%26lc%3Den" rel="noopener sponsored" target="_blank" style="display: inline-block; background: white; color: #ff6f00; padding: 12px 30px; border-radius: 25px; text-decoration: none; font-weight: bold;">Browse GEM Tours &rarr;</a>
    <p style="font-size: 11px; opacity: 0.6; margin-top: 10px; margin-bottom: 0;">Affiliate link — we earn a small commission at no extra cost to you</p>
</div>
...
<div style="background: #f0f7ff; border: 2px solid #1a73e8; border-radius: 10px; padding: 15px 20px; margin: 15px 0; text-align: center;">
    <p style="margin: 0; color: #1a1a2e; font-size: 0.95em;">Skip the ticket queues — book your GEM entry with a guided tour package: <a href="https://tp.media/click?shmarker=688198&amp;promo_id=4497&amp;source_type=deeplink&amp;type=click&amp;campaign_id=137&amp;trs=477897&amp;url=https%3A%2F%2Fwww.getyourguide.com%2Fs%2F%3Fq%3DGrand%2520Egyptian%2520Museum%26lc%3Den" rel="noopener sponsored" target="_blank" style="color: #1a73e8; font-weight: bold; text-decoration: underline;">see guided tour options on GetYourGuide</a></p>
...
<div style="background: linear-gradient(135deg, #1a73e8 0%, #4fc3f7 100%); border-radius: 15px; padding: 25px; margin: 30px 0; color: white; text-align: center;">
    ...
    <a href="https://tp.media/click?shmarker=688198&amp;promo_id=4505&amp;source_type=deeplink&amp;type=click&amp;campaign_id=101&amp;trs=477897&amp;url=https%3A%2F%2Fwww.booking.com%2Fsearchresults.html%3Fss=Giza%2C+Egypt" rel="noopener sponsored" target="_blank" style="display: inline-block; background: white; color: #1a73e8; padding: 12px 30px; border-radius: 25px; text-decoration: none; font-weight: bold;">Search Giza Hotels &rarr;</a>
    <p style="font-size: 11px; opacity: 0.6; margin-top: 10px; margin-bottom: 0;">Affiliate link — we earn a small commission at no extra cost to you</p>
</div>
...
def seed():
    ...
    for data in ARTICLES:
        BlogPost.objects.update_or_create(
            slug=data['slug'],
            defaults={**data, 'author': admin, 'status': 'published', 'content_type': 'article', 'published_at': now}
        )
